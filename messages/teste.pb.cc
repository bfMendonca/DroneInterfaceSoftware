...
void protobuf_AssignDesc_teste_2eproto() GOOGLE_ATTRIBUTE_COLD;
void protobuf_AssignDesc_teste_2eproto() {
  ...
  static const int SimpleMessage_offsets_[1] = {
...
void protobuf_AddDesc_teste_2eproto() GOOGLE_ATTRIBUTE_COLD;
...
const SimpleMessage& SimpleMessage::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_teste_2eproto();
...
void SimpleMessage::InternalSwap(SimpleMessage* other) {
  std::swap(lucky_number_, other->lucky_number_);
...
// required int32 lucky_number = 1;
bool SimpleMessage::has_lucky_number() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
void SimpleMessage::set_has_lucky_number() {
  _has_bits_[0] |= 0x00000001u;
}
void SimpleMessage::clear_has_lucky_number() {
  _has_bits_[0] &= ~0x00000001u;
}
void SimpleMessage::clear_lucky_number() {
  lucky_number_ = 0;
  clear_has_lucky_number();
}
 ::google::protobuf::int32 SimpleMessage::lucky_number() const {
  // @@protoc_insertion_point(field_get:SimpleMessage.lucky_number)
  return lucky_number_;
}
 void SimpleMessage::set_lucky_number(::google::protobuf::int32 value) {
  set_has_lucky_number();
  lucky_number_ = value;
